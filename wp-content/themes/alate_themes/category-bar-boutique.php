...
<div class="container rooms-sec">
    <div class="rooms-title wow animate__animated animate__rubberBand"><?php echo get_queried_object()->name; ?></div>
    <div class="row">
        <?php if (have_posts()) : ?>
        <?php while (have_posts()) : the_post(); ?>
        <div class="col-lg-6 room-wrap ">
            <div class="room wow animate__animated animate__pulse">
